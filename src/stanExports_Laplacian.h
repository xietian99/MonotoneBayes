...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'Laplacian', line 23, column 2 to column 36)",
                                                      " (in 'Laplacian', line 31, column 2 to column 32)",
                                                      " (in 'Laplacian', line 32, column 2 to column 33)",
                                                      " (in 'Laplacian', line 34, column 2 to column 35)",
                                                      " (in 'Laplacian', line 36, column 2 to column 26)",
                                                      " (in 'Laplacian', line 40, column 2 to column 31)",
                                                      " (in 'Laplacian', line 41, column 2 to column 39)",
                                                      " (in 'Laplacian', line 45, column 2 to column 31)",
                                                      " (in 'Laplacian', line 46, column 2 to column 27)",
                                                      " (in 'Laplacian', line 47, column 2 to column 32)",
                                                      " (in 'Laplacian', line 49, column 2 to column 43)",
                                                      " (in 'Laplacian', line 51, column 2 to column 40)",
                                                      " (in 'Laplacian', line 57, column 2 to column 38)",
                                                      " (in 'Laplacian', line 59, column 4 to column 53)",
                                                      " (in 'Laplacian', line 58, column 16 to line 60, column 3)",
                                                      " (in 'Laplacian', line 58, column 2 to line 60, column 3)",
                                                      " (in 'Laplacian', line 61, column 2 to column 30)",
                                                      " (in 'Laplacian', line 62, column 2 to column 44)",
                                                      " (in 'Laplacian', line 63, column 2 to column 45)",
                                                      " (in 'Laplacian', line 68, column 6 to column 95)",
                                                      " (in 'Laplacian', line 66, column 6 to column 53)",
                                                      " (in 'Laplacian', line 65, column 4 to line 68, column 95)",
                                                      " (in 'Laplacian', line 64, column 16 to line 69, column 3)",
                                                      " (in 'Laplacian', line 64, column 2 to line 69, column 3)",
                                                      " (in 'Laplacian', line 70, column 2 to column 26)",
                                                      " (in 'Laplacian', line 72, column 4 to column 52)",
                                                      " (in 'Laplacian', line 71, column 20 to line 73, column 3)",
                                                      " (in 'Laplacian', line 71, column 2 to line 73, column 3)",
                                                      " (in 'Laplacian', line 82, column 2 to column 32)",
                                                      " (in 'Laplacian', line 83, column 2 to column 32)",
                                                      " (in 'Laplacian', line 84, column 2 to column 69)",
                                                      " (in 'Laplacian', line 85, column 2 to column 33)",
                                                      " (in 'Laplacian', line 89, column 4 to column 27)",
                                                      " (in 'Laplacian', line 88, column 17 to line 90, column 3)",
                                                      " (in 'Laplacian', line 88, column 2 to line 90, column 3)",
                                                      " (in 'Laplacian', line 5, column 2 to column 17)",
                                                      " (in 'Laplacian', line 6, column 2 to column 17)",
                                                      " (in 'Laplacian', line 7, column 31 to column 34)",
                                                      " (in 'Laplacian', line 7, column 2 to column 42)",
                                                      " (in 'Laplacian', line 8, column 31 to column 32)",
                                                      " (in 'Laplacian', line 8, column 2 to column 36)",
                                                      " (in 'Laplacian', line 9, column 30 to column 31)",
                                                      " (in 'Laplacian', line 9, column 2 to column 33)",
                                                      " (in 'Laplacian', line 10, column 31 to column 32)",
                                                      " (in 'Laplacian', line 10, column 2 to column 36)",
                                                      " (in 'Laplacian', line 11, column 30 to column 31)",
                                                      " (in 'Laplacian', line 11, column 2 to column 33)",
                                                      " (in 'Laplacian', line 15, column 2 to column 35)",
                                                      " (in 'Laplacian', line 16, column 2 to column 36)",
                                                      " (in 'Laplacian', line 17, column 2 to column 28)",
                                                      " (in 'Laplacian', line 23, column 22 to column 23)",
                                                      " (in 'Laplacian', line 34, column 22 to column 23)",
                                                      " (in 'Laplacian', line 40, column 22 to column 23)",
                                                      " (in 'Laplacian', line 41, column 22 to column 23)",
                                                      " (in 'Laplacian', line 45, column 22 to column 23)",
                                                      " (in 'Laplacian', line 49, column 35 to column 38)",
                                                      " (in 'Laplacian', line 51, column 35 to column 36)"};
...
public:
  ...
  inline std::string model_name() const final { return "model_Laplacian"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_Laplacian(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_Laplacian_namespace::model_Laplacian";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_Laplacian_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      lambda_sq = in__.vector(L);
      current_statement__ = 4;
      for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
        current_statement__ = 4;
        if (jacobian__) {
          current_statement__ = 4;
          assign(lambda_sq, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(lambda_sq[(sym1__ - 1)], 0.0, lp__),
            "assigning variable lambda_sq");
        } else {
          current_statement__ = 4;
          assign(lambda_sq, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(lambda_sq[(sym1__ - 1)], 0.0),
            "assigning variable lambda_sq");
        }}
      ...
      for (int i = 1; i <= L; ++i) {
        ...
        assign(theta, cons_list(index_uni(i), nil_index_list()),
          stan::math::sqrt(((tau0_sq * tau_sq) * lambda_sq[(i - 1)])),
        ...
        check_less_or_equal(function__, "p[sym1__]", p[(sym1__ - 1)], 1.0);}
      {
        ...
        lp_accum__.add(exponential_lpdf<propto__>(lambda_sq, (1.0 / 2)));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_Laplacian_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      
      {
        ...
        current_statement__ = 4;
        assign(lambda_sq_flat__, nil_index_list(),
          context__.vals_r("lambda_sq"),
          "assigning variable lambda_sq_flat__");
        current_statement__ = 4;
        pos__ = 1;
        current_statement__ = 4;
        for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
          current_statement__ = 4;
          assign(lambda_sq, cons_list(index_uni(sym1__), nil_index_list()),
            lambda_sq_flat__[(pos__ - 1)], "assigning variable lambda_sq");
          current_statement__ = 4;
          pos__ = (pos__ + 1);}
      }
      Eigen::Matrix<double, -1, 1> lambda_sq_free__;
      lambda_sq_free__ = Eigen::Matrix<double, -1, 1>(L);
      stan::math::fill(lambda_sq_free__, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 4;
      for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
        current_statement__ = 4;
        assign(lambda_sq_free__,
          cons_list(index_uni(sym1__), nil_index_list()),
          stan::math::lb_free(lambda_sq[(sym1__ - 1)], 0.0),
          "assigning variable lambda_sq_free__");}
      double gamma;
      gamma = std::numeric_limits<double>::quiet_NaN();
      ...
      for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
        vars__.emplace_back(lambda_sq_free__[(sym1__ - 1)]);}
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"alpha_base\",\"type\":{\"name\":\"vector\",\"length\":" << L << "},\"block\":\"parameters\"},{\"name\":\"tau_base_sq\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"tau_scale_sq\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambda_sq\",\"type\":{\"name\":\"vector\",\"length\":" << L << "},\"block\":\"parameters\"},{\"name\":\"gamma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" << L << "},\"block\":\"transformed_parameters\"},{\"name\":\"cumsum_alphaW\",\"type\":{\"name\":\"vector\",\"length\":" << L << "},\"block\":\"transformed_parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" << L << "},\"block\":\"transformed_parameters\"},{\"name\":\"tau_sq\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"denominator\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"xi\",\"type\":{\"name\":\"vector\",\"length\":" << xi_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
