...
#include "stanExports_CovModel_HS.h"

RCPP_MODULE(stan_fit4CovModel_HS_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_CovModel_HS")
