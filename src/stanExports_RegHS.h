...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'RegHS', line 21, column 2 to column 36)",
                                                      " (in 'RegHS', line 24, column 2 to column 25)",
                                                      " (in 'RegHS', line 27, column 2 to column 32)",
                                                      " (in 'RegHS', line 28, column 2 to column 33)",
                                                      " (in 'RegHS', line 30, column 2 to column 40)",
                                                      " (in 'RegHS', line 31, column 2 to column 41)",
                                                      " (in 'RegHS', line 33, column 2 to column 26)",
                                                      " (in 'RegHS', line 37, column 2 to column 31)",
                                                      " (in 'RegHS', line 41, column 2 to column 31)",
                                                      " (in 'RegHS', line 42, column 2 to column 27)",
                                                      " (in 'RegHS', line 43, column 2 to column 35)",
                                                      " (in 'RegHS', line 44, column 2 to column 32)",
                                                      " (in 'RegHS', line 46, column 2 to column 43)",
                                                      " (in 'RegHS', line 51, column 2 to column 40)",
                                                      " (in 'RegHS', line 54, column 2 to column 38)",
                                                      " (in 'RegHS', line 57, column 2 to column 48)",
                                                      " (in 'RegHS', line 59, column 4 to column 72)",
                                                      " (in 'RegHS', line 58, column 16 to line 60, column 3)",
                                                      " (in 'RegHS', line 58, column 2 to line 60, column 3)",
                                                      " (in 'RegHS', line 61, column 2 to column 30)",
                                                      " (in 'RegHS', line 62, column 2 to column 41)",
                                                      " (in 'RegHS', line 67, column 6 to column 100)",
                                                      " (in 'RegHS', line 65, column 6 to column 53)",
                                                      " (in 'RegHS', line 64, column 4 to line 67, column 100)",
                                                      " (in 'RegHS', line 63, column 16 to line 68, column 3)",
                                                      " (in 'RegHS', line 63, column 2 to line 68, column 3)",
                                                      " (in 'RegHS', line 69, column 2 to column 26)",
                                                      " (in 'RegHS', line 71, column 4 to column 56)",
                                                      " (in 'RegHS', line 70, column 20 to line 72, column 3)",
                                                      " (in 'RegHS', line 70, column 2 to line 72, column 3)",
                                                      " (in 'RegHS', line 77, column 2 to column 32)",
                                                      " (in 'RegHS', line 78, column 2 to column 32)",
                                                      " (in 'RegHS', line 79, column 2 to column 69)",
                                                      " (in 'RegHS', line 80, column 2 to column 35)",
                                                      " (in 'RegHS', line 81, column 2 to column 70)",
                                                      " (in 'RegHS', line 82, column 2 to column 43)",
                                                      ...
                                                      " (in 'RegHS', line 7, column 30 to column 31)",
                                                      " (in 'RegHS', line 7, column 2 to column 33)",
                                                      ...
                                                      " (in 'RegHS', line 11, column 2 to column 31)",
                                                      " (in 'RegHS', line 12, column 2 to column 31)",
                                                      " (in 'RegHS', line 13, column 2 to column 35)",
                                                      " (in 'RegHS', line 14, column 2 to column 36)",
                                                      " (in 'RegHS', line 15, column 2 to column 28)",
                                                      " (in 'RegHS', line 21, column 22 to column 23)",
                                                      " (in 'RegHS', line 30, column 22 to column 23)",
                                                      " (in 'RegHS', line 31, column 22 to column 23)",
                                                      " (in 'RegHS', line 37, column 22 to column 23)",
                                                      " (in 'RegHS', line 41, column 22 to column 23)",
                                                      " (in 'RegHS', line 43, column 22 to column 23)",
                                                      " (in 'RegHS', line 46, column 35 to column 38)",
...
public:
  ...
  inline std::string model_name() const final { return "model_RegHS"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_RegHS(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_RegHS_namespace::model_RegHS";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_RegHS_namespace::log_prob";
(void) function__;  // suppress unused var warning
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        if (logical_eq(J[(i - 1)], 1)) {
          ...
          assign(p, cons_list(index_uni(i), nil_index_list()),
            ((((sum(
                  rvalue(alpha,
                    cons_list(index_min_max(1, (J[(i - 1)] - 1)),
                      nil_index_list()), "alpha")) / L) +
                ((X[(i - 1)] - (((J[(i - 1)] - 1) * 1.0) / L)) *
      ...
      for (int i = 2; i <= (L + 1); ++i) {
        ...
        assign(xi, cons_list(index_uni(i), nil_index_list()),
          ((1 +
             (sum(
                rvalue(alpha,
                  cons_list(index_min_max(1, (i - 1)), nil_index_list()),
                  "alpha")) / L)) / denominator), "assigning variable xi");}
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_RegHS_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
